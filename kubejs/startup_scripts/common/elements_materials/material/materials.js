...
GTCEuStartupEvents.registry('gtceu:material', (event) => {
    ...
    elemIngotFluid(
        ...
        [foil, gear, long_rod, plates, rod, rotor, small_gear, ring, frame]
    );
    ...
    elemIngotFluid(
        ...
        [foil, gear, long_rod, plates, rod, rotor, small_gear, ring, frame, fine_wire]
    );
    ...
    compIngotLiquid(
        ...
        [rod, foil, plates, long_rod, frame, no_decomp, no_abs_recipe, bolt_and_screw, ring]
    );
    ...
    compIngotLiquid(
        ...
        [plates, frame, rod, bolt_and_screw, round, long_rod, gear, small_gear, ring, foil, dense_plate]
    );
    ...
    compIngotLiquid(
        ...
        [plates, rod, frame, fine_wire, foil, dense_plate]
    );
    ...
    elemIngotFluid(
        ...
        DULL,
        [5000, 'low', VA('iv'), 1200],
        [foil, gear, long_rod, plates, rod, rotor, small_gear, ring]
    );
    ...
    elemIngotFluid(
        ...
        [plates, rod, no_decomp, dense_plate, frame, long_rod, foil]
    );
    ...
    conductor(
        ...
        [V('uv'), 2, 4, false],
        [plates, frame, rod, bolt_and_screw, round, long_rod, gear, small_gear, ring, dense_plate]
    );
    ...
    compIngotLiquid(
        ...
        [gear, small_gear, rotor, round, frame]
    );
    ...
    compIngotLiquid(
        ...
        METALLIC,
        [1900, 'mid', VA('mv'), 400],
        [no_decomp, plates, rod, frame, foil]
    );
    ...
    polymerFluidPipe(
        ...
        [foil, plates, ring, plates, no_decomp]
    ); //PEDOT
    ...
    compIngotLiquidSecColor(
        ...
        [plates, rod, frame, small_gear, gear, round, ring, bolt_and_screw, long_rod, foil, dense_plate]
    );
    ...
    */
    ...
    conductor(
        ...
        [V('uev'), 6, 16, false],
        [bolt_and_screw, spring, small_spring]
    );
    ...
    conductorPlasma(
        ...
        [V('uev'), 32, 0, true],
        [no_decomp, no_abs_recipe, fine_wire, frame]
    );
    ...
    conductor(
        ...
        [V('uiv'), 5, 24, false],
        [fine_wire, bolt_and_screw, spring, small_spring]
    );
    ...
    conductor(
        ...
        [V('uiv'), 2, 36, false],
        [spring, no_decomp, no_abs_recipe, ring]
    );
    ...
    conductorPlasma(
        ...
        [V('uiv'), 40, 0, true],
        [no_decomp, no_abs_recipe, fine_wire, bolt_and_screw]
    );
    ...
    compIngotPlasmaSecColor(
        ...
        [plates, frame, rod, bolt_and_screw, dense_plate, long_rod, gear, small_gear, no_decomp, no_abs_recipe]
    );
    ...
    conductorPlasma(
        ...
        [18880, 'highest', VA('uxv'), 600],
        [V('uiv'), 1, 192, false],
        [no_decomp, no_abs_recipe, fine_wire]
    );
    ...
    compIngotPlasmaSecColor(
        ...
        SHINY,
        [18880, 'highest', VA('uxv'), 600],
        [plates, frame, rod, bolt_and_screw, dense_plate, long_rod, gear, small_gear, no_decomp, no_abs_recipe, foil]
    );
    ...
    compIngotPlasmaSecColor(
        ...
        SHINY,
        [18880, 'highest', VA('uxv'), 600],
        [plates, frame, rod, bolt_and_screw, dense_plate, long_rod, gear, small_gear, rotor, no_decomp, no_abs_recipe]
    );
    ...
    conductor(
        ...
        [V('uxv'), 7, 48, false],
        [bolt_and_screw, spring, small_spring, no_abs_recipe, no_decomp, fine_wire]
    );
    ...
    event.create('hydrogen_iodide').gas().color(0x8187a6).components('1x hydrogen', '1x iodine').flags(no_decomp);
