        ...
        .pattern((definition) =>
            newFactoryBlockPattern([
                ...
                .whereDict({
                    ...
                    F: P.kjsBlock('kubejs:enriched_naquadah_firebox_casing'),
                    B: P.gtBlock('gtceu:black_steel_frame'),
                    T: P.gtBlock('gtceu:heat_vent'),
                    Z: P.gtBlock('gtceu:zpm_machine_casing'),
                    C: P.gtBlock('gtceu:trinium_coil_block'),
                    P: P.kjsBlock('kubejs:enriched_naquadah_pipe_casing'),
                    N: P.kjsBlock('kubejs:enriched_naquadah_machine_casing'),
