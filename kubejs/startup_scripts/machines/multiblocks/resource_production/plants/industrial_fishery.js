            ...
            newFactoryBlockPattern([
                ...
                .whereDict({
                    ...
                    B: P.anyOf([
                        ...
                        P.abality(PA.itemin, { max: 5, prev: 1 }),
                        P.abality(PA.itemOut, { max: 2, prev: 1 }),
                        P.abality(PA.fluidIn, { max: 5, prev: 1 }),
                        P.abality(PA.euIn, { max: 2, prev: 1 }),
                        P.abality(PA.parallelHatch, { max: 1 }),
                        P.abality(PA.maintenance, { exact: 1 }),
                    ]),
