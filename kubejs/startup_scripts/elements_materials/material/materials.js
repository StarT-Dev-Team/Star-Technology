...
GTCEuStartupEvents.registry('gtceu:material', (event) => {
    ...
    matmod('lead', gear);
    matmod('silver', gear);
    matmod('naquadah', densePlate);
    matmod('enriched_naquadah', [densePlate, rotor, gear, smallGear, frame, longRod]);
    matmod('naquadria', densePlate);
    matmod('neutronium', [foil, smallGear, rotor, densePlate]);
    matmod('europium', [smallSpring, boltAndScrew]);
    matmod('zirconium', fineWire);
    matmod('hafnium', fineWire);
    matmod('rhenium', fineWire);
    matmod('red_steel', [rod, frame]);
    matmod('sterling_silver', [rod, frame]);
    matmod('nether_star', foil);
    matmod('netherite', noDecomp);
    matmod('echo_shard', [lens, foil]);
    matmod('certus_quartz', lens);
    matmod('copper', gear);
    matmod('vanadium_gallium', fineWire);
    matmod('titanium', foil);
    matmod('rhodium_plated_palladium', [frame, foil]);
    matmod('palladium', [rotor]);
    matmod('darmstadtium', [frame, foil]);
    matmod('ruthenium_trinium_americium_neutronate', fineWire);
    matmod('gold', gear);
    matmod('electrum', gear);
    matmod('blue_alloy', gear);
    matmod('cupronickel', smallSpring);
    matmod('kanthal', smallSpring);
    matmod('nichrome', smallSpring);
    matmod('tantalum_carbide', foil);
    matmod('dysprosium', longRod);
    matmod('trinium', fineWire);
    matmod('naquadah_alloy', round);
    matmod('ruridit', [smallGear, rotor]);
    ...
    matmod('uranium_triplatinum', fineWire);
    matmod('samarium_iron_arsenic_oxide', fineWire);
    ...
    const polymerFluidPipe = (name, elements, color, pipe, flags) => {
        event
            ...
            .color(color)
            .flags(flags)
            .fluidPipeProperties(pipe[0], pipe[1], pipe[2], pipe[3], pipe[4], pipe[5]);
    };
    ...
    compIngot('raw_void', ['1x echo_r', '1x neutronium'], 0x006666, DULL, [], [noDecomp]);
    ...
    compLiquidTemp('naquadite_dense_residue', 2560, ['1x mystery', '1x naquadite', '1x mystery'], 0x524848, [noDecomp]);
    ...
    //Estalt Line
    compLiquidTemp('molten_estaltadyne_mixture', 3500, ['1x mystery', '1x estalt', '1x mystery'], 0x8e0505, [noDecomp]);
    ...
    //Adamantine Line
    compLiquid('enriched_adamantamite_mixture', ['1x mystery', '1x adamantine', '1x mystery'], 0x866e4b, [noDecomp]);
    ...
    compLiquidTemp('molten_mythrillic_mixture', 3100, ['1x mystery', '1x mythril', '1x mystery'], 0x238342, [noDecomp]);
    ...
    compLiquidTemp('mythrillic_nether_magma', 9299, ['1x mystery', '1x mythril', '1x mystery'], 0x238383, [noDecomp]);

    compLiquidTemp('adamantamite_nether_magma', 11299, ['1x mystery', '1x adamantine', '1x mystery'], 0x826944, [
        noDecomp,
    ]);

    compLiquidTemp('estaltadyne_nether_magma', 10299, ['1x mystery', '1x estalt', '1x mystery'], 0xa92323, [noDecomp]);
    ...
    // PEEK plastic Line
    compDust(
        'disodium_salt_of_hydroquinone',
        ['6x carbon', '4x hydrogen', '2x oxygen', '2x sodium'],
        0xeaeaf9,
        noDecomp
    );
    ...
    compDust('hafnastide_rich_sludge', ['1x mystery', '1x hafnium', '1x astatine', '1x mystery'], 0xa8798a, [noDecomp]);
    ...
    compLiquid('chlorosulfonic_acid', ['1x hydrogen', '1x sulfur', '3x oxygen', '1x chlorine'], 0xa84e4e, [noDecomp]);
    ...
    compDust('benzophenone_3344_tetracarboxylic_dianhydride', ['17x carbon', '6x hydrogen', '7x oxygen'], 0xd1b9a3, [
        noDecomp,
    ]);
    ...
    compDust('n_methyl_2_pyrrolidone', ['5x carbon', '9x hydrogen', '1x nitrogen', '1x oxygen'], 0xbdc8d8, [noDecomp]);
    ...
    elemGem('purified_naquadah', 0x000807, [], [noDecomp]);
    ...
    */
    ...
    compDust('netherite_hexammine_sulfate', ['1x pure_netherite', '6x ammonia', '1x sulfur', '4x oxygen'], 0x400080, [
        noDecomp,
    ]);
    ...
    compIngot('diamane', ['1x carbon'], 0x62777a, [], [4000, 'low', VA('lv'), 1], [noDecomp]);
...
=======
    compDust('mox239_blend', [`2x ${$U238}`, `2x ${$Pu239}`], 0x289a0a, [noDecomp]);
    compDust('mox241_blend', [`2x ${$U238}`, '2x plutonium_241'], 0x587c13, [noDecomp]);
    compDust('tpu_blend', ['2x thorium', `2x ${$Pu239}`], 0x36aa18, [noDecomp]);
    compDust('mox238_blend', ['3x plutonium_238', `1x ${$Cf252}`], 0x4f2f04, [noDecomp]);
    compDust('etu_blend', ['2x curium_244', `1x ${$Cf252}`, '1x americium_241'], 0x3d5434, [noDecomp]);
    compDust('nqe_blend', ['2x purified_naquadah', '2x einsteinium_253'], 0x3f3c18, [noDecomp]);
>>>>>>> b4f934c2701820adb37cb35960a14c336379bdd8
});
