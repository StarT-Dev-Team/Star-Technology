...
ServerEvents.recipes((event) => {
    ...
    [
        ...
        const logType = log === 'bamboo' ? 'block' : log === 'crimson' || log === 'warped' ? 'stem' : 'log';
        event.recipes.create
            .cutting([`minecraft:stripped_${log}_${logType}`, 'farmersdelight:tree_bark'], `minecraft:${log}_log`)
            .id(`start:cutting/stripped_${log}_${logType}`);
        event.recipes.create
            .cutting(`4x minecraft:${log}_planks`, `minecraft:stripped_${log}_${logType}`)
        ...
        event
            .shaped(`4x functionalstorage:${log}_4`, ['DD', 'DD'], {
